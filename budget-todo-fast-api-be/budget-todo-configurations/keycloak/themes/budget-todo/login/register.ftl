                ...
                <div class="row register-btn ">
                    <div id="kc-form-options" class="col-xs-5 ${properties.kcFormOptionsClass!}">
                        <div class="${properties.kcFormOptionsWrapperClass!}">
                            <span>
                                <a class="btn btn-default  btn-block btn-back"  href="${url.loginUrl}"><i class="fa fa-caret-left display"></i>&nbsp;&nbsp;${msg("backToLogin")}</a>
                            </span>
                        </div>
                    </div>

                    <div id="kc-form-buttons" class="col-xs-7 ${properties.kcFormButtonsClass!}">
                        <input class="btn btn-primary btn-register btn-block ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonLargeClass!}" type="submit" value="${msg("doRegister")}"/>
                    </div>
                </div>
            </div>
        </form>
